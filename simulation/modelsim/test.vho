...
SIGNAL ww_led : std_logic_vector(0 DOWNTO 0);
...
SIGNAL \inst5|LPM_MUX_component|auto_generated|result_node[0]~2_combout\ : std_logic;
...
-- Equation(s):
-- \inst5|LPM_MUX_component|auto_generated|result_node[0]~1_combout\ = (!\inst|counter_out\(23) & (\inst|counter_out\(24) & ((\inst|counter_out\(22)) # (\inst|counter_out\(25)))))
...
-- Equation(s):
-- \inst5|LPM_MUX_component|auto_generated|result_node[0]~0_combout\ = (\inst|counter_out\(22) & ((\inst|counter_out\(23)) # ((!\inst|counter_out\(24) & \inst|counter_out\(25))))) # (!\inst|counter_out\(22) & (\inst|counter_out\(25) $ 
-- (((!\inst|counter_out\(23) & \inst|counter_out\(24))))))
...
\inst5|LPM_MUX_component|auto_generated|result_node[0]~2\ : cycloneii_lcell_comb
-- Equation(s):
-- \inst5|LPM_MUX_component|auto_generated|result_node[0]~2_combout\ = (\button~combout\(0) & (!\inst|counter_out\(26) & ((\inst5|LPM_MUX_component|auto_generated|result_node[0]~1_combout\) # 
-- (!\inst5|LPM_MUX_component|auto_generated|result_node[0]~0_combout\)))) # (!\button~combout\(0) & (((\inst|counter_out\(26)) # (\inst5|LPM_MUX_component|auto_generated|result_node[0]~0_combout\)) # 
-- (!\inst5|LPM_MUX_component|auto_generated|result_node[0]~1_combout\)))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "0101110101011011",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \button~combout\(0),
	datab => \inst5|LPM_MUX_component|auto_generated|result_node[0]~1_combout\,
	datac => \inst|counter_out\(26),
	datad => \inst5|LPM_MUX_component|auto_generated|result_node[0]~0_combout\,
	combout => \inst5|LPM_MUX_component|auto_generated|result_node[0]~2_combout\);
...
-- pragma translate_on
PORT MAP (
	datain => \inst5|LPM_MUX_component|auto_generated|result_node[0]~2_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	devoe => ww_devoe,
	oe => VCC,
